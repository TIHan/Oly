...
[<Sealed;NoComparison>]
type OlySyntaxSeparatorList<'T when 'T :> OlySyntaxNode and 'T : not struct> internal (tree: OlySyntaxTree, start: int, parent: OlySyntaxNode, internalNode: ISyntaxNode) as this =
...
[<Sealed;NoComparison>]
type OlySyntaxList<'T when 'T :> OlySyntaxNode and 'T : not struct> internal (tree: OlySyntaxTree, start: int, parent: OlySyntaxNode, internalNode: ISyntaxNode) as this =
    inherit OlySyntaxNode(tree, parent, internalNode)
...
[<Sealed;NoComparison>]
type OlySyntaxBrackets<'T when 'T :> OlySyntaxNode and 'T : not struct> internal (tree: OlySyntaxTree, start: int, parent: OlySyntaxNode, internalNode: ISyntaxNode) as this =
    inherit OlySyntaxNode(tree, parent, internalNode)
...
[<Sealed;NoComparison>]
type OlySyntaxBracketInnerPipes<'T when 'T :> OlySyntaxNode and 'T : not struct> internal (tree: OlySyntaxTree, start: int, parent: OlySyntaxNode, internalNode: ISyntaxNode) as this =
    inherit OlySyntaxNode(tree, parent, internalNode)
...
[<Sealed;NoComparison>]
type OlySyntaxCurlyBrackets<'T when 'T :> OlySyntaxNode and 'T : not struct> internal (tree: OlySyntaxTree, start: int, parent: OlySyntaxNode, internalNode: ISyntaxNode) as this =
    inherit OlySyntaxNode(tree, parent, internalNode)
...
module OlySyntaxParameter =
    ...
    let (|Pattern|_|) (node: OlySyntaxParameter) : ( OlySyntaxAttributes * OlySyntaxMutability * OlySyntaxPattern * OlySyntaxToken * OlySyntaxType ) option =
        match node.Internal with
        | SyntaxParameter.Pattern _ ->
            Option.Some (System.Runtime.CompilerServices.Unsafe.As node.Children[0], System.Runtime.CompilerServices.Unsafe.As node.Children[1], System.Runtime.CompilerServices.Unsafe.As node.Children[2], System.Runtime.CompilerServices.Unsafe.As node.Children[3], System.Runtime.CompilerServices.Unsafe.As node.Children[4])
        | _ ->
            Option.None
...
[<Sealed;NoComparison>]
type OlySyntaxLet internal (tree, start: int, parent, internalNode: SyntaxLet) as this =
    inherit OlySyntaxNode(tree, parent, internalNode)
...
module OlySyntaxLet =
    ...
    let (|Binding|_|) (node: OlySyntaxLet) : ( OlySyntaxToken * OlySyntaxPattern * OlySyntaxToken * OlySyntaxExpression ) option =
        match node.Internal with
        | SyntaxLet.Binding _ ->
            Option.Some (System.Runtime.CompilerServices.Unsafe.As node.Children[0], System.Runtime.CompilerServices.Unsafe.As node.Children[1], System.Runtime.CompilerServices.Unsafe.As node.Children[2], System.Runtime.CompilerServices.Unsafe.As node.Children[3])
...
module OlySyntaxExpression =
    ...
    let (|MutableArray|_|) (node: OlySyntaxExpression) : ( OlySyntaxToken * OlySyntaxToken * OlySyntaxExpression OlySyntaxSeparatorList * OlySyntaxToken ) option =
        match node.Internal with
    ...
    let (|Let|_|) (node: OlySyntaxExpression) : ( OlySyntaxLet ) option =
        match node.Internal with
        | SyntaxExpression.Let _ ->
            Option.Some (System.Runtime.CompilerServices.Unsafe.As node.Children[0])
        | _ ->
            Option.None
