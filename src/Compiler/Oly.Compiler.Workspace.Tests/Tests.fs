...
let createDocument src (workspace: OlyWorkspace) =
    ...
    let sol, proj = workspace.Solution.CreateProject(OlyPath.Create "olytest", projOptions, "dotnet", OlyTargetInfo("net6", OlyOutputKind.Executable), CancellationToken.None)
